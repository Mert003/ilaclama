...
import kuskovucu from "../../images/tel.jpeg";
  ...
  return (
    <Container className='my-4'>
      ...
      <Link to="/farehasere" onClick={()=>{window.scrollTo(0, 0);}}>
          <Image src={kusengelleyici} alt="Image 2" fluid style={{width:"300px" , height:"300px" , objectFit:"contain"}} />
        ...
        <Link to="/kuskovucu" onClick={()=>{window.scrollTo(0, 0);}}>
          <Image src={kedi} alt="Image 1" fluid style={{width:"300px" , height:"300px" , objectFit:"contain"}} />
        ...
        <Link to="/kusengelleyici" onClick={()=>{window.scrollTo(0, 0);}}>
          <Image src={kuskovucu} alt="Image 2" fluid style={{width:"300px" , height:"300px" , objectFit:"contain"}}/>
        ...
        <Link to="/kedikopekkovucu" onClick={()=>{window.scrollTo(0, 0);}}>
          <Image src={kedi2} alt="Image 3" fluid style={{width:"300px" , height:"300px" , objectFit:"contain"}}/>
